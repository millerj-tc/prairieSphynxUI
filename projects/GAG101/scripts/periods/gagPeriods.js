...
export class scenarioPeriodHandler extends gagPeriodHandler
{
    constructor(){
        ...
        // I don't know if any of this is right. When I imagine myself coding actual stages won't I be adding phases manually? Might want to write some imaginary scenario design code in order to make sure the functions here make sense
    }
}
